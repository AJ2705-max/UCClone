...
namespace UrbanClapClone.DataManager.DAL
{
    public class DBManager : IDisposable, IDBManager
    {
        ...
        // For both SQL query and Stored Produdure
        // use CommandType as CommandType.Text or CommandType.StoredProcedure resp.
        ...
        // Adds a parameter to the command that will be executed against the database.
